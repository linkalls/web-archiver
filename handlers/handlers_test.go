...
// var originalAssetsDir string
// var originalScreenshotsDir string
// var tempStorageCleanup func()

// func TestMain(m *testing.M) {
// 	var err error
// 	testDB, err = tests.SetupTestDB();	if err != nil {
...
// 	originalAssetsDir = storage.AssetsDirForTest()
// 	originalScreenshotsDir = ""
// 	var tempRawDir, tempAssetsDir string
// 	_, tempRawDir, tempAssetsDir, _, tempStorageCleanup, err = tests.EnsureTestStorageDirs()
// 	if err != nil {
...
// 		os.Exit(1)
// 	}
// 	storage.SetStorageBaseDirsForTest(tempRawDir, tempAssetsDir)
// 	exitCode := m.Run()
// 	storage.SetStorageBaseDirsForTest(originalRawHTMLDir, originalAssetsDir)
// 	if tempStorageCleanup != nil {
// 		tempStorageCleanup()
// 	}
// 	os.Exit(exitCode)
